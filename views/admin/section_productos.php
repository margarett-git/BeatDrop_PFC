...
<head>
    ...
    <title><?php echo htmlspecialchars($seccionTitulo); ?> (Admin) - BeatDrop</title>
    <link rel="stylesheet" href="/css/global.css">
</head>
<body>
<header>
    <h1><?php echo htmlspecialchars($seccionTitulo); ?></h1>
    <nav>
        <a href="/admin">Dashboard</a>
        <a href="<?php echo htmlspecialchars($crearUrl); ?>">Nuevo producto</a>
